...
| 1        | The route points plots of 20km de Bruxelles and Trondheim Halvmaraton races are too much zoomed in. Check the calculations of the zooming factor.                                                                                                                                                                    |
...
| 1        | The location of the starting points plot for General is not well centered after adding the point for the Trondheim Halvmaraton race. Check the calculations of the zooming factor.                                                                                                                                   |
...
| 3        | Add section for future races. The CSV should have a column for marking if a race already happened or it is planned.                                                                                                                                                                                                  |
